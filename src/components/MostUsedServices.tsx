...
function ServiceCard({ service, isBookmarked, onBookmark, onView }: ServiceCardProps) {
  ...
  return (
    <motion.article
      ...
      className="group glass-card flex flex-col p-6 hover:border-bhutan-blue/30 hover:shadow-lg hover:shadow-bhutan-blue/5"
    >
...
export function MostUsedServices({ isBookmarked, onBookmark, onView }: MostUsedServicesProps) {
  ...
  return (
    <section id="services" className="bg-slate-50/50 px-4 py-16 dark:bg-slate-900/30 sm:px-6 lg:px-8">
